...
public class CrmModule : IModule
{
    ...
    {
        services.AddScoped<ITaskColumnsRepository, TaskColumnsRepository>();
        services.AddScoped<ITasksColumnsService, TaskColumnsService>();
        services.AddAutoMapper(typeof(TasksColumnMapping));
