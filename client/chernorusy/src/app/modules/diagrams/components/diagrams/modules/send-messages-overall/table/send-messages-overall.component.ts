...
@Component({
  selector: 'app-send-messages-overall-table',
  templateUrl: './send-messages-overall.component.html',
  styleUrls: ['./send-messages-overall.component.scss'],
})
@ChartDashboardItem('Кол-во сообщений по менеджерам', 'send-messages-overall')
export class SendMessagesOverallComponent extends ChartItem {
